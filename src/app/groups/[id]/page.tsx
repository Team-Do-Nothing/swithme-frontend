...
const GroupPage = () => {
    ...
    const [joinBtnOpen, setJoinBtnOpen] = useState<boolean>(false);
        ...
        <div className="flex flex-col w-full items-start justify-center relative">
            ...
            <div
                ...
                <div
                    ...
                    <button onClick={() => setJoinBtnOpen(true)}
                            className="inline-flex flex-col items-center justify-center gap-[10px] px-[30px] py-[20px] relative bg-variable-collection-primary rounded-[12px] overflow-hidden all-[unset] box-border cursor-pointer hover:bg-green-600">
                        <div
                            className="relative w-fit mt-[-1.00px] [font-family:'Inter-SemiBold',Helvetica] font-semibold text-white text-[24px] tracking-[0] leading-[24px] whitespace-nowrap">
                            참여하기
                        </div>
                    </button>
                    <ConfirmModal open={joinBtnOpen} onClose={() => setJoinBtnOpen(false)}>
                        <div className="flex flex-col gap-[10px]"></div>
                        <h1 className="flex justify-center items-center text-xl p-[10px]">OO 스터디에 참여 하시겠습니까?</h1>
