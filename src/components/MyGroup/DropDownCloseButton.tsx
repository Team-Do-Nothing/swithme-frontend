...
export const DropdownCloseButton = ({ text = "button" }: Props) => {
    return (
        <button type="button" className="inline-flex items-center justify-center gap-[10px] px-[15px] py-[20px] relative bg-variable-collection-primary rounded-[12px] overflow-hidden">
