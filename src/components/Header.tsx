...
const Header = () => {
  return (
    <div className="fixed z-50 flex justify-center items-center w-full h-20 overflow-hidden bg-white">
      <div className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 w-full max-w-7xl overflow-hidden">
        ...
        <div className="w-fit flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 overflow-hidden gap-2.5">
          <Link href={"/signin"} className="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 p-2.5 rounded-xl bg-text-300 border border-text-200 text-2xl font-medium cursor-pointer">
              로그인
          </Link>
          <Link href={"/signup"} className="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 p-2.5 rounded-xl bg-text-300 border border-text-200 text-2xl font-medium cursor-pointer">
              회원가입
          </Link>
        </div>
      </div>
